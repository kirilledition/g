#ifndef G_GENOTYPE_CUDA_DRIVER_ABI_H_
#define G_GENOTYPE_CUDA_DRIVER_ABI_H_
...
using CudaDeviceGetAttribute =
    CudaResult (*)(std::int32_t* value, CudaDeviceAttribute attribute, CudaDevice device);
using CudaContextGetCurrent = CudaResult (*)(CudaContext* context);
using CudaContextGetDevice = CudaResult (*)(CudaDevice* device);
using CudaModuleLoadDataEx = CudaResult (*)(
    CudaModule* module,
    const void* image,
...
using CudaLaunchKernel = CudaResult (*)(
...
#endif  // G_GENOTYPE_CUDA_DRIVER_ABI_H_
