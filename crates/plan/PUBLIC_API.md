...
Run request/config DTOs, `PlanError`/`PlanResult`, host-policy plans, prepared-run plans, manifest fingerprints, association/backend enums, runtime/output plan DTOs.
