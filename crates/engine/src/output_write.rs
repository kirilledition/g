...
use g_output::{
    NativeChunkHandle, NativeVariantMetadataHandle, OutputDeliveryToken, OutputError, Regenie2StatisticBatch,
};
...
pub(crate) fn write_host_association_batch(
    ...
    g_output::write_regenie2_multi_trait_chunk_f32(output, active_trait_indices, &chunk_handle, result)
}
