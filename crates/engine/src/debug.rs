//! Debug and compatibility exports for engine internals.
...
pub use crate::coordinator::InjectedCoordinatorFailure;
...
pub use crate::schedule::{
    ...
    BgenDeliveryMethod, CallbackQueueBackpressureObservation, CallbackQueueGetAttemptPlan,
    CallbackQueueGetObservationPlan, CallbackQueueOccupancyState, CallbackQueueOperationObservationPlan,
    CallbackQueuePutAttemptPlan, CallbackQueuePutObservationPlan, CallbackQueueStageBackpressureObservation,
    CallbackQueueStageObservationPlan, CallbackSchedulerState, CallbackWorkerAbortPlan, CallbackWorkerErrorRaisePlan,
    CallbackWorkerErrorUpdatePlan, CallbackWorkerFinishAction, CallbackWorkerFinishPlan, CallbackWorkerJoinPlan,
    CallbackWorkerLifecycleState, CallbackWorkerShutdownTimeouts, CallbackWorkerStartAction,
    ...
    MultiTraitOutputWritePlan, NativeCallbackQueueLimits, ResultInFlightAcquireAttemptPlan,
    ...
    ResultWriteItemKind, ResultWriteItemResourceReleasePlan, ScheduleError, SingleTraitOutputWritePlan,
    ...
    plan_callback_queue_backpressure_observation, plan_callback_queue_get_observation,
    ...
    plan_result_callback_worker_stop, plan_result_in_flight_slot_acquire_observation,
    plan_result_in_flight_slot_release_observation, plan_result_write_handoff, plan_result_write_item_dispatch,
    plan_result_write_item_dispatch_for_kinds, plan_single_trait_binary_gpu_genotype_format_resolution,
