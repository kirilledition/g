...
`InputError`/`InputResult`, alignment input/result DTOs, aligned phenotype groups and multi-trait aligned data, sample-key mode and its string-value contract, sample alignment
