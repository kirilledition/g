...
pub use run_events::{
    ...
    MultiPhenotypeWriterFinishedTelemetryFields, NATIVE_RUNTIME_KNOBS_CONFIGURED_DIAGNOSTIC_EVENT_NAME,
    NATIVE_RUNTIME_KNOBS_CONFIGURED_DIAGNOSTIC_MESSAGE, PREDICTION_SOURCE_LOADED_EVENT_NAME,
    ...
    build_multi_phenotype_writer_finished_telemetry_fields, build_native_runtime_knobs_configured_diagnostic_payload,
