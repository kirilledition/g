...
def build_regenie2_linear_chunk_payload_batch(
    ...
    # Transfer array lists first, then concatenate on CPU to avoid device tracing overhead
    transferred_lists = jax.device_get(
        {
    ...
    host_values = {
        "allele_one_frequency": np.concatenate(transferred_lists["allele_one_frequency"]),
        "observation_count": np.concatenate(transferred_lists["observation_count"]),
        "beta": np.concatenate(transferred_lists["beta"]),
        "standard_error": np.concatenate(transferred_lists["standard_error"]),
        "chi_squared": np.concatenate(transferred_lists["chi_squared"]),
        "log10_p_value": np.concatenate(transferred_lists["log10_p_value"]),
        "valid_mask": np.concatenate(transferred_lists["valid_mask"]),
    }
...
def concatenate_linear_results(
    ...
    # Transfer lists of JAX arrays, then concatenate on CPU
    transferred_lists = jax.device_get(
        {
    ...
    host_values = {
        ...
        "beta": np.concatenate(transferred_lists["beta"]),
        "standard_error": np.concatenate(transferred_lists["standard_error"]),
        "test_statistic": np.concatenate(transferred_lists["test_statistic"]),
        "p_value": np.concatenate(transferred_lists["p_value"]),
        "valid_mask": np.concatenate(transferred_lists["valid_mask"]),
    }
...
def concatenate_logistic_results(
    ...
    host_values = {
        ...
        "test_statistic": np.concatenate(transferred_lists["test_statistic"]),
        "p_value": np.concatenate(transferred_lists["p_value"]),
        "method_code": np.concatenate(transferred_lists["method_code"]),
        "error_code": np.concatenate(transferred_lists["error_code"]),
        "converged_mask": np.concatenate(transferred_lists["converged_mask"]),
        "iteration_count": np.concatenate(transferred_lists["iteration_count"]),
        "valid_mask": np.concatenate(transferred_lists["valid_mask"]),
    }
