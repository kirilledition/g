...
def build_regenie2_linear_chunk_payload_batch(
    ...
    host_values = {
        ...
        "valid_mask": np.concatenate(host_values_lists["valid_mask"]),
    }
...
def concatenate_linear_results(
    ...
    # Single host synchronization (using list conversion to avoid jnp.concatenate JIT/tracing overhead)
    host_values_lists = jax.device_get(
        {
    ...
    host_values = {
        ...
        "beta": np.concatenate(host_values_lists["beta"]),
        "standard_error": np.concatenate(host_values_lists["standard_error"]),
        "test_statistic": np.concatenate(host_values_lists["test_statistic"]),
...
def concatenate_logistic_results(
    ...
    host_values = {
        ...
        "test_statistic": np.concatenate(host_values_lists["test_statistic"]),
        "p_value": np.concatenate(host_values_lists["p_value"]),
        "method_code": np.concatenate(host_values_lists["method_code"]),
        "error_code": np.concatenate(host_values_lists["error_code"]),
        "converged_mask": np.concatenate(host_values_lists["converged_mask"]),
