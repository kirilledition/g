...
def concatenate_linear_results(
    ...
    # Single host synchronization of lists, then concatenate on CPU
    # This avoids variable-sized JIT overhead and reduces peak device memory
    ...
    host_values = {
        "allele_one_frequency": np.concatenate(host_lists["allele_one_frequency"]),
        "observation_count": np.concatenate(host_lists["observation_count"]),
        "beta": np.concatenate(host_lists["beta"]),
        "standard_error": np.concatenate(host_lists["standard_error"]),
        "test_statistic": np.concatenate(host_lists["test_statistic"]),
        "p_value": np.concatenate(host_lists["p_value"]),
        "valid_mask": np.concatenate(host_lists["valid_mask"]),
    }
...
def concatenate_logistic_results(
    ...
    host_values = {
        ...
        "test_statistic": np.concatenate(host_lists["test_statistic"]),
        "p_value": np.concatenate(host_lists["p_value"]),
        "method_code": np.concatenate(host_lists["method_code"]),
        "error_code": np.concatenate(host_lists["error_code"]),
        "converged_mask": np.concatenate(host_lists["converged_mask"]),
        "iteration_count": np.concatenate(host_lists["iteration_count"]),
        "valid_mask": np.concatenate(host_lists["valid_mask"]),
    }
...
def concatenate_regenie2_linear_results(
    ...
    host_values = {
        ...
        "beta": np.concatenate(host_lists["beta"]),
        "standard_error": np.concatenate(host_lists["standard_error"]),
        "chi_squared": np.concatenate(host_lists["chi_squared"]),
        "log10_p_value": np.concatenate(host_lists["log10_p_value"]),
        "valid_mask": np.concatenate(host_lists["valid_mask"]),
    }
