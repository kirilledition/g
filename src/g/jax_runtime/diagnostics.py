...
def diagnostic_event_from_native_event(
    ...
    """Adapt a typed native JAX runtime diagnostic event.

    Args:
        native_event: Native event handle.
...
def diagnostic_field_from_native_field(
    ...
    """Adapt a typed native JAX runtime diagnostic field."""
...
def diagnostic_events_from_native_setup_session(
    ...
    """
    return tuple(
        diagnostic_event_from_native_event(native_event) for native_event in native_setup_session.diagnostic_events()
    )
