...
G_OPTIONS: tuple[OptionSpec, ...] = (
    ...
    OptionSpec(
        "g-result-in-flight-limit",
        "g_result_in_flight_limit",
        SupportLevel.G_EXTENSION,
        "g.compute",
        "Optional cap for computed result chunks awaiting materialization.",
        cli_flags=("--g-result-in-flight-limit", "g_result_in_flight_limit"),
        type=OptionValueType.INTEGER,
    ),
    OptionSpec(
        "g-dosage-buffer-limit",
        "g_dosage_buffer_limit",
        SupportLevel.G_EXTENSION,
        "g.compute",
        "Optional cap for reusable native dosage decode buffers.",
        cli_flags=("--g-dosage-buffer-limit", "g_dosage_buffer_limit"),
        type=OptionValueType.INTEGER,
    ),
    OptionSpec(
        "g-variant-limit",
    ...
    OptionSpec(
        ...
        "g_linear_minimum_variance",
        SupportLevel.G_EXTENSION,
        "g.compute",
        "Linear residualized genotype variance numerical floor.",
        cli_flags=("--g-linear-minimum-variance", "g_linear_minimum_variance"),
        type=OptionValueType.FLOAT,
    ),
    OptionSpec(
        "g-linear-relative-variance-tolerance",
        "g_linear_relative_variance_tolerance",
        SupportLevel.G_EXTENSION,
        "g.compute",
        "Relative linear residualized genotype variance floor multiplier.",
        cli_flags=("--g-linear-relative-variance-tolerance", "g_linear_relative_variance_tolerance"),
        type=OptionValueType.FLOAT,
    ),
    OptionSpec(
    ...
    OptionSpec(
        ...
        cli_flags=("--g-trace-event-cap", "g_trace_event_cap"),
        type=OptionValueType.INTEGER,
    ),
    OptionSpec(
        "g-log-queue-size",
...
PYTHON_ALIASES_BY_NAME = {
    ...
    "g-trace-event-cap": ("trace_event_cap",),
