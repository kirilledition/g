...
def select_null_firth_attempt_result(
    operands: regenie2_binary_firth_types.NullFirthFallbackOperands,
) -> regenie2_binary_firth_types.NullFirthFitResult:
    """Select the already-computed null Firth attempt result."""
    return operands.attempt_result


def run_fourth_null_firth_attempt(
    operands: regenie2_binary_firth_types.NullFirthFallbackOperands,
) -> regenie2_binary_firth_types.NullFirthFitResult:
    """Run the final null Firth fallback attempt."""
...
def run_third_or_fourth_null_firth_attempt(
    operands: regenie2_binary_firth_types.NullFirthFallbackOperands,
) -> regenie2_binary_firth_types.NullFirthFitResult:
    """Run the third null Firth attempt and the fourth only if needed."""
    parameters = operands.parameters
    ...
    third_operands = regenie2_binary_firth_types.NullFirthFallbackOperands(
        parameters=parameters,
        attempt_result=third_result,
    )
    return jax.lax.cond(
        third_result.converged,
        select_null_firth_attempt_result,
        run_fourth_null_firth_attempt,
        third_operands,
    )


def run_second_or_later_null_firth_attempt(
    operands: regenie2_binary_firth_types.NullFirthFallbackOperands,
) -> regenie2_binary_firth_types.NullFirthFitResult:
    """Run the second null Firth attempt and later fallbacks only if needed."""
    parameters = operands.parameters
    ...
    second_operands = regenie2_binary_firth_types.NullFirthFallbackOperands(
        parameters=parameters,
        attempt_result=second_result,
    )
    return jax.lax.cond(
        second_result.converged,
        select_null_firth_attempt_result,
        run_third_or_fourth_null_firth_attempt,
        second_operands,
    )
