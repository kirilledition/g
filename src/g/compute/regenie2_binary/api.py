...
binary_chunk_diagnostics_to_mapping = regenie2_binary_diagnostics.binary_chunk_diagnostics_to_mapping
...
def compute_regenie2_multi_binary_chunk_from_chromosome_state_variant_major_no_overflow(
    ...
    observation_count: jax.Array | None = None,
    score_dtype: g_types.FloatingPointDtype = g_types.FloatingPointDtype.FLOAT32,
    tiny_candidate_capacity: int = 0,
    small_candidate_capacity: int = 0,
    bounded_candidate_capacity: int = 0,
    ...
    correction_module = regenie2_binary_variant_major_correction
