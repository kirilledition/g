...
def merge_firth_variant_result_into_multi_chunk(
    *,
    ...
    return regenie2_binary_result.Regenie2MultiBinaryChunkResult(
        ...
        extra_code=result.extra_code.at[active_trait_indices, active_variant_indices].set(merged_extra_code),
        valid_mask=result.valid_mask.at[active_trait_indices, active_variant_indices].set(active_valid_mask),
        firth_iteration_count=result.firth_iteration_count.at[active_trait_indices, active_variant_indices].set(
            firth_result.iteration_count[active_flat_positions]
        ),
        firth_failure_code=result.firth_failure_code.at[active_trait_indices, active_variant_indices].set(
            firth_result.failure_code[active_flat_positions]
        ),
        firth_convergence_reason_code=result.firth_convergence_reason_code.at[
            active_trait_indices,
            active_variant_indices,
        ].set(firth_result.convergence_reason_code[active_flat_positions]),
        firth_correction_code=result.firth_correction_code.at[active_trait_indices, active_variant_indices].set(
            firth_result.correction_code[active_flat_positions]
        ),
        firth_sparse_correction_mask=result.firth_sparse_correction_mask.at[
            active_trait_indices,
            active_variant_indices,
        ].set(firth_result.sparse_correction_mask[active_flat_positions]),
        pseudo_firth_iteration_count=result.pseudo_firth_iteration_count.at[
            active_trait_indices,
            active_variant_indices,
        ].set(firth_result.pseudo_firth_iteration_count[active_flat_positions]),
        nr_zero_start_iteration_count=result.nr_zero_start_iteration_count.at[
            active_trait_indices,
            active_variant_indices,
        ].set(firth_result.nr_zero_start_iteration_count[active_flat_positions]),
        nr_warm_start_iteration_count=result.nr_warm_start_iteration_count.at[
            active_trait_indices,
            active_variant_indices,
        ].set(firth_result.nr_warm_start_iteration_count[active_flat_positions]),
    )
