...
def apply_device_candidate_corrections_firth_variant_major(
    ...
    if capacity_plan.bounded_candidate_capacity == variant_count:
        return dispatch.apply_device_candidate_corrections_firth_variant_major_with_device_dispatch(
    ...
    return dispatch.apply_device_candidate_corrections_firth_variant_major_with_overflow_dispatch(
        chromosome_state=chromosome_state,
        genotype_matrix_by_variant=genotype_matrix_by_variant,
        result=result,
        correction_plan=correction_plan,
        overflow_candidate_capacity=candidate_count,
        sparse_candidate_mask=sparse_candidate_mask,
        dosage_sum=dosage_sum,
        observation_count=observation_count,
        kernel_config=kernel_config,
...
def apply_device_candidate_corrections_firth_packed8(
    ...
    return jax.lax.cond(
        ...
        lambda _: dispatch.apply_device_candidate_corrections_firth_packed8_with_device_dispatch(
            chromosome_state=chromosome_state,
        ...
        lambda _: dispatch.apply_device_candidate_corrections_firth_packed8_with_overflow_dispatch(
            chromosome_state=chromosome_state,
            packed_probability_pairs_by_variant=packed_probability_pairs_by_variant,
            result=result,
            correction_plan=correction_plan,
