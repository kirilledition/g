...
def apply_firth_variant_major_fixed_capacity_corrections(
    *,
    ...
    prepared_batch = regenie2_binary_firth_batch_prepare.prepare_firth_candidate_batch(
    ...
    firth_result = regenie2_binary_firth_batch_compute.compute_firth_variantwise_fixed_batches(
...
def apply_firth_packed8_fixed_capacity_corrections(
    *,
    ...
    firth_batch_size = min(kernel_config.firth_candidate.batch_size, candidate_capacity)
    prepared_batch = regenie2_binary_firth_batch_prepare.prepare_firth_candidate_batch_from_packed8(
        chromosome_state=chromosome_state,
