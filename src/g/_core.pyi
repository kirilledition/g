...
class NativeRunRequest:
    ...
    @property
    def input(self) -> NativeRunRequestInput: ...
    @property
    def trait_request(self) -> NativeRunRequestTrait: ...
    @property
    def compute(self) -> NativeRunRequestCompute: ...
    @property
    def correction(self) -> NativeRunRequestCorrection: ...
    @property
    def output(self) -> NativeRunRequestOutput: ...
    @property
    def runtime(self) -> NativeRunRequestRuntime: ...
    @property
    def phenotype_runs(self) -> list[NativePhenotypeRunPlan]: ...
    @property
    def phenotype_compute_groups(self) -> list[NativePhenotypeComputeGroup]: ...
    @property
    def stage_timings_json(self) -> str | None: ...

class NativeRunRequestInput:
    @property
    def bgen_path(self) -> str: ...
    @property
    def sample_path(self) -> str | None: ...
    @property
    def phenotype_path(self) -> str: ...
    @property
    def prediction_list_path(self) -> str: ...
    @property
    def covariate_path(self) -> str | None: ...
    @property
    def covariate_names(self) -> list[str]: ...
    @property
    def sample_key_mode(self) -> str: ...

class NativeRunRequestTrait:
    @property
...
class NativeRunRequestCompute:
    ...
    def trusted_no_missing_diploid(self) -> bool: ...
    @property
    def trusted_bgen_validation_mode(self) -> str: ...
    @property
    def multi_phenotype_sample_mode(self) -> str: ...
    @property
    def score_dtype(self) -> str: ...
    @property
    def firth_dtype(self) -> str: ...

class NativeRunRequestCorrection:
    @property
    def method(self) -> str: ...
    @property
    def p_threshold(self) -> float: ...
...
class NativeRunRequestOutput:
    ...
    def finalize_parquet(self) -> bool: ...
    @property
    def writer_thread_count(self) -> int: ...
    @property
    def writer_queue_depth(self) -> int: ...
    @property
    def chunks_per_arrow_file(self) -> int: ...
    @property
    def arrow_compression(self) -> str: ...
    @property
...
class NativeRunRequestRuntime:
    @property
    def jax_cache_directory(self) -> str | None: ...
    @property
    ...
    @property
    def xla_autotune_cache_enabled(self) -> bool: ...
    @property
...
class NativePhenotypeComputeGroup:
    ...
    @property
    def phenotype_indices(self) -> list[int]: ...
    @property
...
class NativeStageTimingSnapshot:
    ...
    @property
    def chunk_stage_timings(self) -> list[NativeChunkStageTimingSnapshot]: ...
    @property
    def native_bgen_profile(self) -> dict[str, int]: ...
    @property
    def binary_chunk_diagnostics(self) -> tuple[dict[str, int | float], ...]: ...
    @property
    def null_logistic_diagnostics(self) -> tuple[dict[str, int | str], ...]: ...
    @property
    def queue_backpressure(self) -> list[NativeQueueBackpressureSnapshot]: ...
    @property
    def transfer_metadata(self) -> list[NativeTransferMetadataSnapshot]: ...
...
class NativeRunEventPayloadPolicy:
    ...
    def build_run_completed_event(self, artifacts: object) -> NativeRunCompletedEvent: ...
    def build_run_interrupted_event_payload(self, shutdown_request: object) -> dict[str, object]: ...
    def build_run_interrupted_event(self, shutdown_request: object) -> NativeRunInterruptedEvent: ...
    def build_run_failed_event_payload(self, error: BaseException) -> dict[str, object]: ...
    def build_run_failed_event(self, error: BaseException) -> NativeRunFailedEvent: ...
...
class NativeRunArtifacts:
    ...
    @property
    def phenotype_artifacts(self) -> list[NativeRunArtifacts]: ...
    @property
...
class NativeRunCompletedEvent:
    ...
    def phenotype_count(self) -> int | None: ...
    @property
    def artifacts(self) -> list[NativeRunArtifact]: ...
...
class NativeHostAssociationBackendPlan:
    @property
...
class NativeHostPhenotypeComputeGroupPlan:
    @property
    def group_mode(self) -> str: ...
    @property
    def phenotype_indices(self) -> list[int]: ...
...
class NativeHostPlanningPolicy:
    ...
    ) -> NativeHostAssociationBackendPlan: ...
    ...
    def build_phenotype_compute_groups(
        ...
        phenotype_names: typing.Sequence[str],
        multi_phenotype_sample_mode: str,
    ) -> list[NativeHostPhenotypeComputeGroupPlan]: ...
