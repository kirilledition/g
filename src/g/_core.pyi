...
class NativeOutputWriterLifecyclePolicy:
    def __init__(self) -> None: ...
    ...
    def abort_writer_sessions(self, writer_sessions: list[OutputWriterSession]) -> None: ...
...
def config_from_options(raw_options: typing.Mapping[str, object]) -> RegenieConfig: ...
def config_from_toml(path: str | Path) -> RegenieConfig: ...
def load_packaged_config() -> RegenieConfig: ...
def config_option_schema() -> list[dict[str, object]]: ...
