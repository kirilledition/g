...
def explain_config_option(name: str) -> str: ...
def iter_config_explanations() -> list[str]: ...
def decode_config_toml_mapping(toml_data: bytes | str, source: str) -> dict[str, typing.Any]: ...
def flatten_config_toml_mapping(raw_options: typing.Mapping[str, typing.Any]) -> dict[str, typing.Any]: ...
def normalize_config_option_name(option_name: str) -> str: ...
def normalize_config_option_dictionary(raw_options: typing.Mapping[str, typing.Any]) -> dict[str, typing.Any]: ...
def option_dictionary_to_config_toml_layer(
