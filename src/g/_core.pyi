...
class NativeCallbackRuntimeResources:
    ...
    def finish_worker_lifecycle(self) -> NativeCallbackWorkerFinishLifecycleResult: ...
    ...
    def get_result_write_item_with_drain_completion(
        self,
        flush_binary_correction_diagnostics_on_stop: bool,
    ) -> NativeResultWriteItemDrainResult: ...
...
class NativeShutdownController:
    ...
    def request_shutdown_or_raise_second_signal_payload(self, signal_number: int) -> dict[str, object]: ...
