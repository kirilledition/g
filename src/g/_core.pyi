...
class NativeMultiTraitRunInput:
    @property
    def native_aligned_sample_data(self) -> None: ...
    @property
    def native_multi_aligned_sample_data(self) -> NativeMultiAlignedSampleData: ...
    @property
...
class NativeCallbackProgressUpdate:
    # Opaque native telemetry token passed back into `_core`.
    ...
...
class NativeCliTelemetrySessionView:
    @property
    def mode(self) -> str: ...
    @property
    def paths(self) -> NativeCliTelemetryPaths: ...
    @property
    def enabled(self) -> bool: ...
    @property
    def profile_enabled(self) -> bool: ...
    ...
    def run_id(self) -> str: ...
    @property
    def native_session_handle(self) -> NativeTelemetryRunSession: ...
    @property
    def native_telemetry_session(self) -> NativeTelemetryRunSession | None: ...
...
def record_callback_progress_update_telemetry(
    telemetry_session: object | None,
    progress_update: NativeCallbackProgressUpdate,
) -> None: ...
