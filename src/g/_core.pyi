...
class NativeChunkStageTimingSnapshot:
    @property
    def chunk_identifier(self) -> int: ...
    @property
    def chromosome(self) -> str: ...
...
class NativeBinaryChunkDiagnosticsSnapshot:
    @property
    def score_only_count(self) -> int | float | None: ...
    @property
    def score_test_candidate_count(self) -> int | float | None: ...
    @property
    def firth_candidate_count(self) -> int | float | None: ...
    @property
    def firth_iteration_min(self) -> int | float | None: ...
    @property
    def firth_iteration_median(self) -> int | float | None: ...
    @property
    def firth_iteration_max(self) -> int | float | None: ...
    @property
    def firth_converged_count(self) -> int | float | None: ...
    @property
    def firth_failed_count(self) -> int | float | None: ...
    @property
    def firth_numerical_failure_count(self) -> int | float | None: ...
    @property
    def firth_max_iteration_failure_count(self) -> int | float | None: ...
    @property
    def firth_invalid_statistic_failure_count(self) -> int | float | None: ...
    @property
    def firth_step_halving_failure_count(self) -> int | float | None: ...
    @property
    def pseudo_firth_attempt_count(self) -> int | float | None: ...
    @property
    def pseudo_firth_success_count(self) -> int | float | None: ...
    @property
    def nr_zero_start_attempt_count(self) -> int | float | None: ...
    @property
    def nr_zero_start_success_count(self) -> int | float | None: ...
    @property
    def nr_warm_start_attempt_count(self) -> int | float | None: ...
    @property
    def nr_warm_start_success_count(self) -> int | float | None: ...
    @property
    def sparse_correction_count(self) -> int | float | None: ...
    @property
    def dense_correction_count(self) -> int | float | None: ...

class NativeNullLogisticDiagnosticsSnapshot:
    @property
    ...
    @property
    def firth_iteration_count(self) -> int | None: ...
    @property
    def firth_convergence_reason_code(self) -> int | None: ...
    @property
    def correction_method(self) -> str | None: ...

class NativeQueueBackpressureSnapshot:
    @property
    def queue_name(self) -> str: ...
    @property
    def operation_name(self) -> str: ...
...
class NativeTransferMetadataSnapshot:
    @property
    def transfer_name(self) -> str: ...
    @property
    def array_role(self) -> str: ...
    @property
...
class NativeStageTimingSnapshot:
    @property
    def stage_totals_seconds(self) -> dict[str, float]: ...
    @property
    def stage_counts(self) -> dict[str, int]: ...
    @property
    def chunk_stage_timings(self) -> tuple[NativeChunkStageTimingSnapshot, ...]: ...
    @property
    def native_bgen_profile(self) -> dict[str, int]: ...
    @property
    def binary_chunk_diagnostics(self) -> tuple[NativeBinaryChunkDiagnosticsSnapshot, ...]: ...
    @property
    def null_logistic_diagnostics(self) -> tuple[NativeNullLogisticDiagnosticsSnapshot, ...]: ...
    @property
    def queue_backpressure(self) -> tuple[NativeQueueBackpressureSnapshot, ...]: ...
    @property
    def transfer_metadata(self) -> tuple[NativeTransferMetadataSnapshot, ...]: ...
...
class NativeStageTimingRecorder:
    ...
    def snapshot(self) -> NativeStageTimingSnapshot: ...
...
def normalize_binary_correction_plan(
    firth: bool,
    approx: bool,
    spa: bool,
    p_threshold: float,
    firth_se: bool,
) -> NativeBinaryCorrectionPlan: ...
...
def compile_run_request(config: RegenieConfig) -> NativeRunRequest: ...
...
def record_runner_run_started_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_runner_run_interrupted_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_runner_run_failed_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_runner_run_completed_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_execution_plan_prepared_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_effective_config_written_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_writer_finished_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_multi_writer_finished_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_single_trait_preflight_completed_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_multi_phenotype_preflight_completed_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
...
def record_gpu_genotype_format_resolved_telemetry_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
...
def record_runner_run_started_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_runner_run_interrupted_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_runner_run_failed_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_runner_run_completed_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
...
def record_runner_execution_plan_prepared_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
...
def record_native_cli_stdout_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_native_cli_stderr_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_native_cli_interrupted_line_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_native_cli_failed_line_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_native_cli_completed_line_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_native_runtime_knobs_configured_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_preflight_warning_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
def record_io_output_resume_committed_chunks_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
...
def record_pipeline_gpu_genotype_format_resolved_diagnostic_event(*args: typing.Any, **kwargs: typing.Any) -> None: ...
