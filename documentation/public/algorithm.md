...
its exact quantized minor-allele count is strictly less than `50` and its
oriented zero-dosage class contains at least half of the observed, nonmissing
samples. Sparse correction keeps samples whose oriented, mean-imputed dosage
before residualization is greater than
