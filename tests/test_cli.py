...
def test_print_success_message_prefers_tsv_path(capsys: typing.Any) -> None:
    print_success_message(RunArtifacts(sumstats_tsv=Path("results.tsv")))
    captured = capsys.readouterr()
    assert "results.tsv" in captured.out
