...
class ManualCallbackRunner(callback_runtime.NativeBgenCallbackRunner):
    ...
    def worker_error(self) -> BaseException | None:
        return getattr(self, "_manual_worker_error", None)

    @worker_error.setter
    def worker_error(self, error: BaseException | None) -> None:
        self._manual_worker_error = error
    ...
    def result_worker_error(self) -> BaseException | None:
        return getattr(self, "_manual_result_worker_error", None)

    @result_worker_error.setter
    def result_worker_error(self, error: BaseException | None) -> None:
        self._manual_result_worker_error = error
    ...
    def record_processed_chunk(self, chunk_identity: typing.Any) -> typing.Any:
    ...
    def finish_progress_state(self) -> typing.Any:
    ...
    def plan_dosage_buffer_pool_reuse_observation(self) -> typing.Any:
        return self.callback_scheduler_state.plan_dosage_buffer_pool_reuse_observation()

    def plan_dosage_buffer_pool_return_observation(self) -> typing.Any:
        return self.callback_scheduler_state.plan_dosage_buffer_pool_return_observation()

    def plan_dosage_buffer_pool_allocate_observation(self) -> typing.Any:
        return self.callback_scheduler_state.plan_dosage_buffer_pool_allocate_observation()

    def plan_dosage_buffer_pool_discard_observation(self) -> typing.Any:
        return self.callback_scheduler_state.plan_dosage_buffer_pool_discard_observation()

    def plan_dosage_buffer_pool_consumer_wait_observation(self) -> typing.Any:
    ...
    def plan_dosage_work_handoff(self, *, chunk_count: int) -> typing.Any:
        return self.callback_scheduler_state.plan_dosage_work_handoff(chunk_count=chunk_count)

    def plan_dosage_work_handoff_for_object(self, work_item: object) -> typing.Any:
        if isinstance(work_item, callback_shared.PreprocessedVariantMajorDosageChunkBatchWorkItem):
    ...
    def plan_variant_major_dosage_batch_handoff_for_sequences(
        self,
        metadata_batch: typing.Sequence[typing.Any],
        genotype_matrix_by_variant_batch: typing.Sequence[typing.Any],
        chunk_stats_batch: typing.Sequence[typing.Any],
    ) -> typing.Any:
    ...
    def put_dosage_work_item(self, work_item: object) -> None:
        self.start()
        if self.stage_timing_recorder is None:
            while True:
    ...
    def put_result_write_item(self, work_item: object) -> None:
        self.start()
        if self.stage_timing_recorder is None:
            while True:
                self.raise_worker_error_if_present()
    ...
    def abort(self) -> None:
        ...
        if abort_plan.stop_dosage_worker:
            with contextlib.suppress(callback_shared.NativeBgenWorkerShutdownError):
    ...
    def plan_dosage_buffer_return_attempt(self, *, buffer_identifier: int) -> typing.Any:
    ...
    def acquire_dosage_buffer_with_shape(
        ...
        while True:
            self.raise_worker_error_if_present()
            dosage_buffer: typing.Any | None = None
            ...
            if acquire_plan.should_take_free_buffer:
                ...
                if not free_buffer_result.has_item:
                    ...
                    raise RuntimeError(message)
                dosage_buffer = free_buffer_result.item
    ...
    def release_dosage_buffer(self, dosage_buffer: typing.Any) -> None:
    ...
    def allocate_dosage_buffer_with_shape(self, expected_shape: tuple[int, ...], dtype: typing.Any) -> typing.Any:
        dosage_buffer = np.empty(expected_shape, dtype=dtype, order="C")
    ...
    def discard_dosage_buffer_slot(self, dosage_buffer: typing.Any) -> None:
        discard_plan = self.callback_scheduler_state.plan_dosage_buffer_discard_attempt(id(dosage_buffer))
    ...
    def release_numpy_dosage_buffer(self, dosage_buffer: object) -> None:
        if isinstance(dosage_buffer, np.ndarray):
            self.release_dosage_buffer(dosage_buffer)
    ...
    def release_result_work_item_host_buffer(self, work_item: typing.Any) -> bool:
    ...
    def release_result_work_item_in_flight_slot(self, work_item: typing.Any) -> None:
...
def test_native_callback_runtime_resources_own_queue_operations() -> None:
    ...
    dosage_observed_get_result = runtime_resources.get_dosage_work_item_with_observation()
    assert dosage_observed_get_result.has_item is True
    assert dosage_observed_get_result.item is dosage_item
    ...
    dosage_work_item_get_observation_plan = dosage_work_item_get_result.observation_plan
    assert dosage_work_item_get_observation_plan is not None
    assert dosage_work_item_get_observation_plan.queue_name == "dosage_queue"
    ...
    assert runtime_resources.put_dosage_work_item_with_backpressure_observation(dosage_item).should_retry_put is False
    dosage_optional_get_result = runtime_resources.get_dosage_work_item_with_optional_observation_and_drain_completion()
    ...
    result_observed_get_result = runtime_resources.get_result_write_item_with_observation()
    assert result_observed_get_result.has_item is True
    assert result_observed_get_result.item is result_item
    ...
    assert result_stop_drain_result.drain_completion_plan.should_flush_binary_correction_diagnostics is True
    assert runtime_resources.put_result_write_item_with_backpressure_observation(result_item).should_retry_put is False
    ...
    result_work_item_get_observation_plan = result_work_item_get_result.observation_plan
    assert result_work_item_get_observation_plan is not None
    assert result_work_item_get_observation_plan.queue_name == "result_queue"
    ...
    assert runtime_resources.put_result_write_item_with_backpressure_observation(result_item).should_retry_put is False
    result_optional_get_result = (
        runtime_resources.get_result_write_item_with_optional_observation_and_drain_completion()
    )
...
def test_native_callback_runtime_resources_own_dispatch_and_drain_plans() -> None:
    ...
    object_dosage_handoff_plan = runtime_resources.plan_dosage_work_handoff_for_object(sample_major_work_item)
    assert object_dosage_handoff_plan.chunk_count == 1
    object_batch_handoff_plan = runtime_resources.plan_dosage_work_handoff_for_object(
        callback_shared.PreprocessedVariantMajorDosageChunkBatchWorkItem(
            work_items=(variant_major_work_item, variant_major_work_item)
        )
    )
    assert object_batch_handoff_plan.chunk_count == 2
    with pytest.raises(ValueError, match="at least one chunk"):
        runtime_resources.plan_dosage_work_handoff(0)
    with pytest.raises(ValueError, match="at least one chunk"):
        runtime_resources.plan_dosage_work_handoff_for_object(None)
    ...
    variant_major_sequence_handoff_plan = runtime_resources.plan_variant_major_dosage_batch_handoff_for_sequences(
        (metadata, metadata),
        (
    ...
    assert variant_major_sequence_handoff_plan.chunk_count == 2
    ...
    with pytest.raises(ValueError, match="identical lengths"):
        runtime_resources.plan_variant_major_dosage_batch_handoff_for_sequences(
            (metadata, metadata),
            (np.ones((2, 2), dtype=np.float32),),
            (chunk_stats, chunk_stats),
        )
...
def test_native_callback_runtime_resources_own_result_work_item_resource_cleanup() -> None:
    ...
    pre_write_buffer_observation_plan = pre_write_result.dosage_buffer_pool_observation_plan
...
def test_native_callback_runtime_resources_own_dosage_buffer_acquisition() -> None:
    ...
    observed_runtime_resources = callback_runtime._core.NativeCallbackRuntimeResources(
        worker_name="native-resource-observed-dosage-buffer-acquire-test",
        dosage_worker_target=worker_target,
        result_worker_target=worker_target,
        staging_depth=1,
        native_callback_batch_size=1,
    ...
    observed_dosage_buffer = np.empty((2, 2), dtype=np.float32)
    observed_allocate_result = observed_runtime_resources.acquire_dosage_buffer_with_backpressure_timeout()
    assert observed_allocate_result.should_allocate is True
    assert observed_runtime_resources.register_dosage_buffer(id(observed_dosage_buffer)) == 0

    observed_acquisition_started = threading.Event()

    def observed_acquire_after_pool_capacity_is_full() -> _core.NativeDosageBufferAcquireResult:
        observed_acquisition_started.set()
        return observed_runtime_resources.acquire_dosage_buffer_with_backpressure_timeout()

    with concurrent.futures.ThreadPoolExecutor(max_workers=1) as executor:
        observed_future = executor.submit(observed_acquire_after_pool_capacity_is_full)
        assert observed_acquisition_started.wait(timeout=1.0)
        time.sleep(0.02)
        assert not observed_future.done()

        assert observed_runtime_resources.return_dosage_buffer(id(observed_dosage_buffer), observed_dosage_buffer) == 1
...
def test_native_callback_runner_derives_dosage_handoffs_natively() -> None:
    class DosageHandoffRuntimeResourcesProbe:
        def __init__(self, runtime_resources: callback_runtime._core.NativeCallbackRuntimeResources) -> None:
            self.runtime_resources = runtime_resources
            self.handoff_work_items: list[object] = []
            self.batch_sequences: list[tuple[object, object, object]] = []
        ...
        def plan_dosage_work_handoff_for_object(
            self,
            work_item: object,
        ) -> callback_runtime._core.NativeDosageWorkHandoffPlan:
            self.handoff_work_items.append(work_item)
            return self.runtime_resources.plan_dosage_work_handoff_for_object(work_item)
        ...
        ) -> callback_runtime._core.NativeVariantMajorDosageBatchHandoffPlan:
            self.batch_sequences.append((metadata_batch, genotype_matrix_by_variant_batch, chunk_stats_batch))
            return self.runtime_resources.plan_variant_major_dosage_batch_handoff_for_sequences(
                metadata_batch,
                genotype_matrix_by_variant_batch,
                chunk_stats_batch,
            )

        def plan_dosage_work_handoff(
            self,
            chunk_count: int,
        ) -> callback_runtime._core.NativeDosageWorkHandoffPlan:
            del chunk_count
            raise AssertionError("production runner should derive dosage handoff counts from work item objects")
        ...
        def plan_variant_major_dosage_batch_handoff(
            ...
            *,
            ...
            del metadata_count, genotype_matrix_by_variant_count, chunk_stats_count
            raise AssertionError("production runner should derive variant-major batch handoff counts from sequences")
    ...
    def put_dosage_work_item_probe(work_item: object) -> None:
        queued_work_items.append(work_item)

    first_metadata = build_native_metadata_for_chunk(chunk_identifier=0)
    second_metadata = build_native_metadata_for_chunk(chunk_identifier=2)
    chunk_stats = typing.cast("_core.ChunkStats", SimpleNamespace())
    runtime_resources_probe = DosageHandoffRuntimeResourcesProbe(callback.callback_runtime_resources)
    metadata_batch = (first_metadata, second_metadata)
    genotype_matrix_by_variant_batch = (
        np.ones((2, 2), dtype=np.float32),
        np.full((2, 2), 2.0, dtype=np.float32),
    ...
    try:
        callback_for_probe.callback_runtime_resources = runtime_resources_probe
        callback_for_probe.put_dosage_work_item = put_dosage_work_item_probe
        callback.compute_preprocessed_dosage_chunk(
            metadata=first_metadata,
            genotype_matrix=np.ones((2, 2), dtype=np.float32),
            chunk_stats=chunk_stats,
        ...
        callback.compute_preprocessed_variant_major_dosage_chunk_batch(
            ...
            genotype_matrix_by_variant_batch=genotype_matrix_by_variant_batch,
            chunk_stats_batch=chunk_stats_batch,
        )
    finally:
        callback_for_probe.callback_runtime_resources = original_runtime_resources
        callback.finish()
    ...
    assert runtime_resources_probe.handoff_work_items == queued_work_items
    assert runtime_resources_probe.batch_sequences == [
        (metadata_batch, genotype_matrix_by_variant_batch, chunk_stats_batch)
    ]
    assert isinstance(queued_work_items[0], callback_shared.PreprocessedDosageChunkWorkItem)
    assert isinstance(queued_work_items[1], callback_shared.PreprocessedVariantMajorDosageChunkWorkItem)
    assert isinstance(
        queued_work_items[2],
        callback_shared.PreprocessedVariantMajorPacked8ProbabilityPairChunkWorkItem,
    )
    assert isinstance(queued_work_items[3], callback_shared.PreprocessedVariantMajorDosageChunkBatchWorkItem)
...
def test_native_callback_runner_uses_scheduler_result_write_drain_completion_plan() -> None:
    ...
    drain_completion_plan = callback.plan_result_write_drain_completion(None)
...
def test_native_bgen_callback_runner_uses_native_runtime_resources() -> None:
    ...
    assert not hasattr(callback, "fallback_callback_scheduler_state")
    assert callback.progress_state is resolved_runtime_resources.progress_state
    assert not hasattr(callback, "fallback_progress_state")
    assert callback.binary_correction_summary is resolved_runtime_resources.binary_correction_summary
    assert not hasattr(callback, "fallback_binary_correction_summary")
