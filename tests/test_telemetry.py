...
def test_resolve_telemetry_paths_defaults_to_output_run_logs() -> None:
    ...
    assert telemetry_paths.event_file == expected_log_dir / "events.jsonl"
...
def test_trace_telemetry_paths_default_profile_and_trace_outputs() -> None:
    ...
    assert telemetry_paths.event_file == log_dir / "events.jsonl"
    assert telemetry_paths.trace_file == log_dir / "trace.jsonl"
